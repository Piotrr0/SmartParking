...
import com.smartparking.user.dto.AuthRequest;
...
import com.smartparking.user.dto.AuthResponse;
                ...
                .map(user -> {
                    if (passwordEncoder.matches(request.getPassword(), user.getPassword())) {
                        return ResponseEntity
                                .ok(new AuthResponse(user.getId(), user.getUsername(), "Login successful"));
                    } else {
